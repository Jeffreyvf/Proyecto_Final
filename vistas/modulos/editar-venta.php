              ...
              <div class="box">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <option value="<?php echo $cliente["id"]; ?>"><?php echo $cliente["razon"]; ?></option>
                    ...
                    <?php
                      ...
                      $categorias = ControladorCliente::ctrMostrarCliente($item, $valor);

                       foreach ($categorias as $key => $value) {

                         echo '<option value="'.$value["id"].'">'.$value["razon"].'</option>';
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                              ...
                              <input type="hidden" class="form-control input-lg" min="0" id="nuevoImpuestoVenta" name="nuevoImpuestoVenta" value="<?php echo $porcentajeImpuesto; ?>" >
