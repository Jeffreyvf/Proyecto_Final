...
$bloque1 = <<<EOF
	...
	<table>
		...
		<tr>
			...
			<td style="width:150px"><img src="images/nota.png"></td>
			...
			<td style="background-color:white; width:140px">
				...
				<div style="font-size:8.5px; text-align:right; line-height:15px;">
					...
					<br>
					<b>Dirección:</b> Mercado La Guardia Puesto #160
			...
			<td style="background-color:white; width:110px; text-align:center; color:red"><br><br># Nota Venta <br>$valorVenta</td>
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="border: 1px solid #666; background-color:white; width:390px">
				...
				Cliente: $respuestaCliente[razon]
